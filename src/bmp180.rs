...
impl Mode {
    ...
    fn wait_conversion<D: DelayMs<u16>>(&self, delay: &mut D) {
        let ms = match self {
...
impl<I: Write + WriteRead> BMP180<I> {
    ...
    #[inline]
    fn get_ut<D: DelayMs<u16>>(&mut self, delay: &mut D) -> i32 {
    ...
    #[inline]
    fn get_up<D: DelayMs<u16>>(&mut self, delay: &mut D) -> i32 {
    ...
    /// Calculate true temperature, in 0.1C
    pub fn get_temperature<D: DelayMs<u16>>(&mut self, delay: &mut D) -> i32 {
    ...
    pub fn get_pressure<D: DelayMs<u16>>(&mut self, delay: &mut D) -> i32 {
        let oss = self.mode.oversampling_settings();
